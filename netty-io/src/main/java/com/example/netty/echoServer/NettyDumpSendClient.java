package com.example.netty.echoServer;

import com.example.common.util.Logger;
import com.example.netty.NettyDemoConfig;
import com.example.netty.handle.NettyEchoClientHandler;
 ...
 * （1）粘包，指Receiver（接收端）收到一个ByteBuf，包含了Sender（发送端）的多个
 * ByteBuf，发送端的多个ByteBuf在接收端“粘”在了一起。
 * （2）半包，就是Receiver将Sender的一个ByteBuf“拆”开了收，收到多个破碎的包。
 *
 */
