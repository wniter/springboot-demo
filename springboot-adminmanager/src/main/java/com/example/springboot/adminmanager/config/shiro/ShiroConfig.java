package com.example.springboot.adminmanager.config.shiro;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean getShiroFilterFactoryBean(DefaultSecurityManager securityManager, Realm realm) {
        ...
        List<com.example.springboot.adminmanager.entity.sys.Resource> list = resourceService.findAll();
        for (com.example.springboot.adminmanager.entity.sys.Resource resource : list) {
